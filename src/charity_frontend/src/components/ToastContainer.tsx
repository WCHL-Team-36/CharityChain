        ...
        return (
          <div
            ...
            className={`
              ...
              ${toast.type === "success" ? "border-l-4 border-green-500" : toast.type === "error" ? "border-l-4 border-red-500" : toast.type === "warning" ? "border-l-4 border-yellow-500" : "border-l-4 border-blue-500"}
            `}
            style={{
              maxWidth: "100vw",
          ...
          >
            <div className="p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 w-0 flex-1">
                  <p className="text-sm font-semibold text-gray-900 leading-tight break-words">{toast.title}</p>
                  {toast.message && <p className="mt-1 text-sm text-gray-600 leading-relaxed break-words">{toast.message}</p>}
                </div>
            ...
            <div className="h-1 bg-gray-100">
              <div className={`h-1 toast-progress ${toast.type === "success" ? "bg-green-500" : toast.type === "error" ? "bg-red-500" : toast.type === "warning" ? "bg-yellow-500" : "bg-blue-500"}`} />
            </div>
          </div>
        );
      })}
